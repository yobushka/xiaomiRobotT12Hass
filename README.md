...
### 📂 Project Files
*   **[scripts.yaml](./scripts.yaml)** - Ready-to-use scripts for Home Assistant.
*   **[10_project_summary_2026_02_08.md](./10_project_summary_2026_02_08.md)** - Detailed technical report and history of the solution.
*   **[log.json](./log.json)** - Sample log file (Redacted) showing the hidden room configuration.
